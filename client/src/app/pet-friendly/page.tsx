  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-8 bg-[#f8f9fa] text-[#2b2b2b]">
      ...
      <div className="bg-white border border-gray-200 p-8 sm:p-12 rounded-3xl shadow-sm space-y-4 text-center max-w-4xl mx-auto">
        <div className="p-3 bg-[#f15e75]/10 text-[#f15e75] rounded-2xl w-fit mx-auto">
          <Dog className="w-8 h-8" />
        </div>
        <h1 className="text-3xl sm:text-4xl font-extrabold text-[#2b2b2b]">Pet-Friendly Vacation Rentals</h1>
        <p className="text-gray-600 text-sm max-w-2xl mx-auto">
          Bring your furry family members along! Explore dog-friendly cabins and chalets with fenced yards, hiking access, and spacious decks in the Pocono Mountains.
        </p>
      </div>
